...
def register_classification_callbacks_handlers(
    ...
    application.add_handler(
        CallbackQueryHandler(_approve_wrapper, pattern=r"^classify_approve:")
    )

    application.add_handler(
        CallbackQueryHandler(_correct_wrapper, pattern=r"^classify_correct:")
    )

    application.add_handler(
        CallbackQueryHandler(_reject_wrapper, pattern=r"^classify_reject:")
    )
    ...
    application.add_handler(
        CallbackQueryHandler(_finance_wrapper, pattern=r"^classify_finance:")
    )

    application.add_handler(
        CallbackQueryHandler(_back_wrapper, pattern=r"^classify_back:")
    )
