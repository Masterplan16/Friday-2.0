...
def register_event_callbacks_handlers(
    ...
    application.add_handler(
        CallbackQueryHandler(_approve_wrapper, pattern=r"^event_approve:")
    )

    application.add_handler(
        CallbackQueryHandler(_modify_wrapper, pattern=r"^event_modify:")
    )

    application.add_handler(
        CallbackQueryHandler(_ignore_wrapper, pattern=r"^event_ignore:")
    )

    application.add_handler(
        CallbackQueryHandler(_back_wrapper, pattern=r"^event_back:")
    )
