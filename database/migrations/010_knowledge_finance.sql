...
CREATE INDEX IF NOT EXISTS idx_accounts_type ON knowledge.financial_accounts(account_type);
...
CREATE INDEX IF NOT EXISTS idx_transactions_account ON knowledge.financial_transactions(account_id);
CREATE INDEX IF NOT EXISTS idx_transactions_date ON knowledge.financial_transactions(transaction_date DESC);
CREATE INDEX IF NOT EXISTS idx_transactions_category ON knowledge.financial_transactions(category);
CREATE INDEX IF NOT EXISTS idx_transactions_anomaly ON knowledge.financial_transactions(anomaly_detected) WHERE anomaly_detected = true;
CREATE INDEX IF NOT EXISTS idx_transactions_duplicate ON knowledge.financial_transactions(is_duplicate) WHERE is_duplicate = true;
