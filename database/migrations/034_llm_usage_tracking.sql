...
-- Note: index daily supprimé car timestamp::date n'est pas IMMUTABLE.
-- Utiliser idx_llm_usage_timestamp avec range filter (WHERE timestamp >= date AND timestamp < date+1).
