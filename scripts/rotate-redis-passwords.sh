...
echo "2. Chiffrer .env avec SOPS : ./scripts/encrypt-env.sh"
echo "3. Redemarrer les services Friday (up -d, PAS restart) :"
echo "     docker compose --project-name friday-20 up -d"
