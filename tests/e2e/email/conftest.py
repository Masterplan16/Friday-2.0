"""
Configuration pytest pour tests E2E email.

Initialise TrustManager pour tests E2E necessitant @friday_action.
"""
...
class MockAsyncPool:
    """Mock d'un pool asyncpg pour tests E2E."""
...
def initialize_trust_manager():
    """
    Initialise TrustManager en mode mock pour tests E2E.

    Necessaire pour les fonctions utilisant @friday_action decorator.
    """
    # Creer mock pool avec vrai async context manager
    ...
    # (TrustManager n'a pas de methode close pour l'instant)
