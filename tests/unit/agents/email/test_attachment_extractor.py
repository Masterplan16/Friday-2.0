...
class TestExtractAttachments:
    ...
    async def test_extract_no_attachments(
        self,
        mock_emailengine,
        mock_redis,
        mock_db_pool
    ...
    async def test_extract_mime_type_blocked(
        self,
        mock_emailengine,
        mock_redis,
        mock_db_pool
    ...
    async def test_extract_attachment_too_large(
        self,
        mock_emailengine,
        mock_redis,
        mock_db_pool
    ...
    async def test_extract_download_failure(
        self,
        mock_emailengine,
        mock_redis,
        mock_db_pool
    ...
    async def test_extract_multiple_attachments_mixed(
        ...
        mock_emailengine.download_attachment.side_effect = [
            b'PDF content',
            b'JPEG content'
        ]
    ...
    async def test_extract_db_insert_failure(
        self,
        mock_emailengine,
        mock_redis,
        mock_db_pool
    ...
    async def test_extract_updates_email_has_attachments(
        ...
        update_calls = [
            call for call in mock_db_pool.execute.call_args_list
