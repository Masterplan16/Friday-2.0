...
class TestMigrationsSyntax:
    ...
    def test_migration_027_has_unique_constraints(self, migrations_dir):
        ...
        assert (
            "email_anon TEXT NOT NULL UNIQUE" in content
        ), "Migration 027 missing UNIQUE on email_anon"
        assert (
            "email_hash TEXT NOT NULL UNIQUE" in content
        ), "Migration 027 missing UNIQUE on email_hash"
    ...
    def test_migration_028_has_indexes(self, migrations_dir):
        ...
        assert (
            "idx_urgency_keywords_active" in content
        ), "Migration 028 missing idx_urgency_keywords_active"
    ...
    def test_migration_027_has_check_constraints(self, migrations_dir):
        ...
        assert (
            "priority_override IN ('high', 'urgent')" in content
        ), "Migration 027 missing priority_override CHECK"
        assert (
            "emails_received_count >= 0" in content
        ), "Migration 027 missing emails_received_count CHECK"
